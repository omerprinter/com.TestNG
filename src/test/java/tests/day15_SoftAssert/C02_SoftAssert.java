...
public class C02_SoftAssert {
    ...
    public void test01(){
        ...
        String actDropDownSecim=select.getFirstSelectedOption().getText();
        String expDropdownSecim="Eurozone (euro)";
        softAssert.assertEquals(actDropDownSecim,expDropdownSecim,"urozone secimi testi failed");
